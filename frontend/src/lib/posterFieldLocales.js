...
const FIELD_LABELS = {
  ...
  PRODUCT_NAME: { pt: "Nome do produto", en: "Product name", es: "Producto", fr: "Produit" },
  MODEL_NAME: { pt: "Modelo", en: "Model name", es: "Modelo", fr: "Modèle" },
  PROMO_TEXT: { pt: "Texto promocional", en: "Promo text", es: "Texto promo", fr: "Texte promo" },
  META_LABEL: { pt: "Etiqueta meta (data)", en: "Meta label (date)", es: "Etiqueta meta", fr: "Étiquette meta" },
  CATEGORY_TAG: { pt: "Categoria", en: "Category tag", es: "Categoría", fr: "Catégorie" },
  BENEFIT: { pt: "Benefícios", en: "Benefits", es: "Beneficios", fr: "Avantages" },
  GAME_TITLE: { pt: "Jogo", en: "Game title", es: "Juego", fr: "Jeu" },
  CHANNEL_NAME: { pt: "Canal", en: "Channel name", es: "Canal", fr: "Chaîne" },
  STREAM_TIME: { pt: "Horário live", en: "Stream time", es: "Horario live", fr: "Heure live" },
  EPISODE_TITLE: { pt: "Episódio", en: "Episode title", es: "Episodio", fr: "Épisode" },
  SIZE_INFO: { pt: "Tamanhos", en: "Sizes", es: "Tallas", fr: "Tailles" },
  SWIPE_TEXT: { pt: "Texto swipe", en: "Swipe hint", es: "Texto swipe", fr: "Texte swipe" },
  BEFORE_LABEL: { pt: "Etiqueta «antes»", en: "Before label", es: "Etiqueta «antes»", fr: "Avant" },
  AFTER_LABEL: { pt: "Etiqueta «depois»", en: "After label", es: "Etiqueta «después»", fr: "Après" },
  PHONE: { pt: "Telefone", en: "Phone", es: "Teléfono", fr: "Téléphone" },
  WEBSITE: { pt: "Website", en: "Website", es: "Web", fr: "Site web" },
  PRICE: { pt: "Preço", en: "Price", es: "Precio", fr: "Prix" },
  CTA: { pt: "Chamada à ação", en: "Call to action", es: "CTA", fr: "Appel à l'action" },
  HEADLINE: { pt: "Manchete", en: "Headline", es: "Titular", fr: "Titre" },
...
export const POSTER_CAT_KEYS = {
  ...
  social: "post_cat_social",
  automotive: "post_cat_automotive",
  beauty: "post_cat_beauty",
  retail: "post_cat_retail",
  gaming: "post_cat_gaming",
  youtube: "post_cat_youtube",
