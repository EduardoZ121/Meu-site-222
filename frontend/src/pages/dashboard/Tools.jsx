          ...
          >
            ...
            >
              ...
              <div className="p-3">
                ...
                {tool.cost > 0 ? (
                  <p className="text-[#5A5A5E] text-[10px] font-mono uppercase tracking-wider mt-1">{tool.cost} créditos</p>
                ) : (
                  <p className="text-[#7C3AED] text-[10px] font-mono uppercase tracking-wider mt-1">Grátis</p>
                )}
              </div>
            </Link>
          </motion.div>
