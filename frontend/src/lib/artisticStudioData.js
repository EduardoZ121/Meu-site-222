...
export const ARTISTIC_STUDIO_STYLES = [
  ...
  { id: "lab_qwen_edit", cat: "nsfw", adminOnly: true, labPreset: true, textEngine: "flux", editEngine: "kontext", labBadge: "QWEN", label: "Qwen Edit Rapid", labelEn: "Qwen Edit Rapid", desc: "Edição rápida IA, identidade preservada", descEn: "Rapid AI edit, identity preserved", suffix: "Qwen-style rapid image edit, high fidelity transformation, preserve subject identity and pose, intelligent inpainting quality, photorealistic edit pass, mature artistic edit", gradient: ["#0c0a1f", "#6366f1", "#22d3ee"], icon: "zap" },
  ...
  { id: "lab_hybrid_nsfw", cat: "nsfw", adminOnly: true, labPreset: true, textEngine: "flux", editEngine: "kontext", labBadge: "AIO", label: "Rapid AIO Blend", labelEn: "Rapid AIO Blend", desc: "Preset all-in-one estilo HF rapid", descEn: "All-in-one rapid HF-style preset", suffix: "all-in-one rapid image edit pipeline, blended diffusion edit, identity-locked transformation, mature editorial artistic edit, high coherence rapid pass", gradient: ["#831843", "#9333ea", "#06b6d4"], icon: "zap" },
  ...
  { id: "nsfw_oil_body", cat: "nsfw", adminOnly: true, tier: "heavy", label: "Oil & Gloss Body", labelEn: "Oil & Gloss Body", desc: "Óleo na pele, brilho corporal", descEn: "Oiled glossy skin", suffix: "oiled glossy body mature photography, specular highlights on skin, dramatic studio light, explicit sensual art direction", gradient: ["#422006", "#fbbf24", "#1c1917"], icon: "sun" },
