...
const TOOLS = [
  ...
  { id: "art", tier: "image", category: "generation", to: "/app/artistic",
    name: "Estilos Artísticos", cost: 12,
  ...
  { id: "upscale", tier: "image", category: "utility", to: "/app/tools/upscale",
    name: "Aumentar Resolução", cost: 6,
