...
export default function Upscale() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto pb-32" data-testid="upscale-frame">
      ...
      <StudioStickyCta testId="upscale-cta-bar">
        ...
        >
          {busy ? (
            <><Loader2 className="w-4 h-4 animate-spin" strokeWidth={2} /> {t("common_processing")}</>
          ) : (
            <><Sparkles className="w-4 h-4" strokeWidth={1.5} /> {t("upscale_btn", { n: cost })}</>
          )}
        </button>
      </StudioStickyCta>
    </div>
