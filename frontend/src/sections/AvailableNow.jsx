...
const courses = [
  ...
  { icon: Palette, color: "text-[#8A8A8E]", bg: "bg-[#8A8A8E]/10", label: "Disponível", title: "Pôsteres Pro", desc: "44 templates do bot prontos a editar.", meta: ["44 templates", "5 categorias", "desde 10 créditos"] },
];
