export default function ArtisticStep({ step, title, hint, children, className = "" }) {
  return (
    <section className={`as-v2-step border-b border-white/[0.05] pb-7 last:border-0 last:pb-0 ${className}`}>
