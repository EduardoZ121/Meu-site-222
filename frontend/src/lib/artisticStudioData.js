...
export const ARTISTIC_STYLE_CATEGORIES = [
  ...
  { id: "nsfw", label: "Experimental (Admin)", labelEn: "Experimental (Admin)", adminOnly: true },
];
...
export const ARTISTIC_STUDIO_STYLES = [
  ...
  // —— NSFW experimental (admin only) ——
  { id: "nsfw_boudoir", cat: "nsfw", adminOnly: true, label: "Boudoir", labelEn: "Boudoir", desc: "Retrato íntimo artístico (experimental)", descEn: "Artistic intimate portrait (experimental)", suffix: "artistic boudoir photography style, intimate mood, soft romantic lighting, elegant sensual atmosphere, mature artistic portrait", gradient: ["#1e1b4b", "#be185d", "#fce7f3"], icon: "gem" },
  { id: "nsfw_pinup", cat: "nsfw", adminOnly: true, label: "Pin-up Glam", labelEn: "Pin-up Glam", desc: "Glamour retro sensual (experimental)", descEn: "Sensual retro glam (experimental)", suffix: "glamorous pin-up photography style, retro sensual pose, studio beauty lighting, mature editorial glamour", gradient: ["#9f1239", "#fbbf24", "#1e3a8a"], icon: "sparkles" },
  { id: "nsfw_ecchi", cat: "nsfw", adminOnly: true, label: "Ecchi Anime", labelEn: "Ecchi Anime", desc: "Anime maduro estilizado (experimental)", descEn: "Stylized mature anime (experimental)", suffix: "mature ecchi anime illustration style, stylized attractive character, anime shading, adult-oriented anime art", gradient: ["#fce7f3", "#f472b6", "#7c3aed"], icon: "star" },
  { id: "nsfw_romance", cat: "nsfw", adminOnly: true, label: "Romance Cover", labelEn: "Romance Cover", desc: "Capa novela romântica (experimental)", descEn: "Romance novel cover (experimental)", suffix: "romance novel book cover illustration, passionate mature atmosphere, dramatic lighting, bestselling romance cover art", gradient: ["#7f1d1d", "#f472b6", "#1e1b4b"], icon: "frame" },
  { id: "nsfw_lingerie", cat: "nsfw", adminOnly: true, label: "Lingerie Editorial", labelEn: "Lingerie Editorial", desc: "Fashion íntimo editorial (experimental)", descEn: "Intimate fashion editorial (experimental)", suffix: "lingerie fashion editorial photography, luxury intimate apparel campaign, professional studio fashion, mature tasteful", gradient: ["#0a0a0a", "#fda4af", "#f8fafc"], icon: "sparkles" },
  { id: "nsfw_classical", cat: "nsfw", adminOnly: true, label: "Nu Clássico Pintura", labelEn: "Classical Nude Painting", desc: "Nu artístico museu (experimental)", descEn: "Museum artistic nude (experimental)", suffix: "classical fine art nude painting, Renaissance museum aesthetic, tasteful artistic nude study, oil on canvas master style", gradient: ["#44403c", "#d6d3d1", "#fef3c7"], icon: "brush" },
  { id: "nsfw_dark", cat: "nsfw", adminOnly: true, label: "Dark Sensual", labelEn: "Dark Sensual", desc: "Mood sombrio sensual (experimental)", descEn: "Dark sensual mood (experimental)", suffix: "dark sensual artistic photography, moody shadows, mysterious mature atmosphere, cinematic intimate drama", gradient: ["#0a0a0a", "#4c0519", "#7c3aed"], icon: "moon" },
  { id: "nsfw_fantasy", cat: "nsfw", adminOnly: true, label: "Fantasy Pin-up", labelEn: "Fantasy Pin-up", desc: "Fantasia mature ilustrada (experimental)", descEn: "Mature fantasy illustration (experimental)", suffix: "fantasy pin-up illustration, heroic mature fantasy character, stylized sensual fantasy art, digital painting", gradient: ["#312e81", "#ec4899", "#fbbf24"], icon: "star" },
];
