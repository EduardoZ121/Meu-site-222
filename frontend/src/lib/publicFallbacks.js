...
export const FALLBACK_PADRAO_STYLES = [
  ...
  },
  {
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "Use the reference photo and make an ultra-realistic close-up portrait, [subject] wearing an elegant strapless black suit, seductive and confident expression, striking red lipstick, dramatic fashion lighting with a soft circular spotlight in the background, cinematic aesthetic of beauty editorial photography, ultra HD, preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "wom_coffee",
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "A full-length studio photograph with a professional and elegant aesthetic. It captures [subject] seated in a light wooden chair with a seat and back upholstered in light fabric and straw accents. The subject sits in a confident and relaxed pose, slightly turned toward the camera, with a gentle smile. One hand rests on the arm of the chair, and the legs are crossed at the ankles. Wearing a suit (blazer and pants) in a neutral tone (light beige or gray-green) over a white or cream top. On the feet are light-colored high-heeled shoes with ankle straps. Wearing delicate jewelry: a necklace with a pendant, earrings, and rings. Nails painted a vibrant red. Hair styled medium-length with soft waves, combed to the side. The background is a solid-colored studio backdrop in a uniform, light brown tone. The lighting is studio-style, soft, and directional, coming from a frontal-upward angle. Captured with a prime portrait lens (85mm) on a full-frame camera, f/4.5, ISO 100, 1/200s. Studio lighting with a large softbox as the main light. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "wom_mirror",
  ...
  },
  {
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "Create a soft aesthetic selfie featuring [subject] with a gentle confident expression. Lighting warmer and softer, dreamy glow on the skin. Background is a smooth dark wall. Outfit casual modern. Soft natural makeup. Overall mood calm, refined, and gentle while keeping a believable phone-selfie look. Camera: phone selfie, 35mm, f/2.0, ISO 200. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_joker",
    ...
    "grp": "classic",
    "subject": "the person",
    "prompt": "Generate a striking portrait with a central theme of duality and hidden identity. The image should feature [subject] holding a Joker-style clown mask in front of the face. The subject should be depicted in grayscale, suggesting a somber or desaturated reality, with a thoughtful or melancholic expression in the visible eye. The hand, holding the mask, should be detailed and possibly gloved or armored, also in grayscale. The clown mask, however, should be in vibrant color, with its classic red smile, red nose, and blue markings around the eyes, appearing vivid and unsettlingly cheerful. The background should be dark and minimalistic to emphasize the contrast between the subject and the mask. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_rembrandt",
  ...
  },
  {
    ...
    "grp": "classic",
    "subject": "the person",
    "prompt": "Black and white editorial magazine portrait, focus on [subject] seated on a sofa, confident introspective expression, direct gaze to camera, relaxed pose with hand supporting the chin, light dress shirt with a few buttons open, soft side lighting creating contrast and depth, sophisticated interior with curtains and modern decor in the background, realistic skin and fabric texture, high sharpness, professional photographic quality, 85mm f/1.8 lens, cinematic monochrome style. Negative: blurry, cartoonish, oversaturated, smiling, colored image, low contrast. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_lion_winter",
  ...
  },
  {
    ...
    "grp": "lion",
    "subject": "the person",
    "prompt": "Create a powerful cinematic scene showing [subject] and a lion face to face in a warm desert environment, symbolizing dominance and unity. Calm and confident expression, eyes slightly closed, while the lion stands firmly with its mane flowing in the wind. Golden sand dunes stretch across the background with a glowing sunset horizon. Warm orange and gold tones dominate the scene. Strong directional lighting from the side creates dramatic shadows and highlights on the face and lion's fur. Ultra-realistic, cinematic, 8K, golden hour. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_lion_shadow",
    ...
    "grp": "lion",
    "subject": "the person",
    "prompt": "Create a dark cinematic scene showing [subject] and a lion in a mysterious connection within a shadowy environment. Eyes closed, deep introspective expression, while the lion appears partially hidden in darkness. Background filled with fog, dark tones, and minimal light. A single soft light source illuminates the faces, creating strong contrast and chiaroscuro effect. The atmosphere should feel spiritual, intense, and symbolic. Ultra-realistic, dark cinematic, 8K, low-key lighting. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_phone_spotify",
  ...
  },
  {
    ...
    "grp": "phone",
    "subject": "the person",
    "prompt": "Create a futuristic neon-style scene in vertical 9:16 format featuring [subject] standing on a giant smartphone screen displaying a music interface. The environment glows with purple and blue neon lights. Wearing headphones, oversized hoodie, and streetwear outfit. High-angle top-down shot emphasizing scale. Cyberpunk aesthetic with glowing reflections. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_phone_apple",
  ...
  },
  {
    ...
    "grp": "bw",
    "subject": "the person",
    "prompt": "Create a black and white portrait featuring [subject] with classic Rembrandt lighting but softened for a more elegant and timeless look. Gentle shadow transitions, subtle highlights, and a refined artistic tone. Background remains dark with a soft texture. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_hk_noir",
    "nome": "💻 Hacker Noir",
  ...
  },
  {
    ...
    "grp": "hacker",
    "subject": "the person",
    "prompt": "Create a rainy night portrait featuring [subject] wearing a hood, standing under light rain with water droplets visible. Streetlights reflect softly in the background. Face illuminated by a faint screen glow. Moody, cinematic, dark tones, subtle reflections on skin and clothing. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_cr_dom",
  ...
  },
  {
    ...
    "grp": "crimson",
    "subject": "the person",
    "prompt": "Create a vertical cinematic portrait featuring [subject] with deep shadows covering part of the face. Low upward angle with dramatic contrast. Background remains deep crimson red but darker toward edges. Lighting sharper with stronger shadow cuts, creating a mysterious and intense presence. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_cr_glow",
    ...
    "grp": "crimson",
    "subject": "the person",
    "prompt": "Create a vertical portrait featuring [subject] with softer cinematic lighting and smoother transitions between light and shadow. Slight upward angle maintained. Background is a gradient crimson red with subtle glow. More elegant and refined mood. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_nw_warrior",
    "nome": "⚡ Guerreiro Neon",
  ...
  },
  {
    ...
    "grp": "neon",
    "subject": "the person",
    "prompt": "Edit this image featuring [subject] surrounded by mystical purple energy resembling magical aura. Clothing remains dark but slightly more textured and arcane-inspired. Floating particles resemble sparks and smoke. Background darker with shadowy gradients. Expression serious and powerful, mystical atmosphere. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_em_break",
  ...
  },
  {
    ...
    "grp": "emotion",
    "subject": "the person",
    "prompt": "Create a high-contrast black and white portrait featuring [subject] with intense dramatic lighting. Expression exhausted and emotionally heavy. Strong shadows cut across the face creating a harsh, cinematic mood. Hair messy with hands gripping it more tightly. Background dark and minimal. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_em_analog",
    ...
    "grp": "emotion",
    "subject": "the person",
    "prompt": "Create a black and white portrait featuring [subject] with a vintage analog film aesthetic. Expression tired and vulnerable. Add subtle grain, film texture, and slight imperfections. Lighting medium contrast with natural falloff. Background soft and blurred. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_sk_extreme",
    "nome": "🔬 Pele Extrema",
  ...
  },
  {
    ...
    "grp": "skin",
    "subject": "the person",
    "prompt": "Create an extreme close-up portrait featuring [subject] with softer moisture detail and smoother skin transitions. Dewy skin with subtle shine, wet strands lightly touching the face. Lighting softer but still directional, creating gentle highlights and refined shadows. Focus remains on the eye with high clarity. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_sk_raw",
    "nome": "🩹 Textura Crua",
    ...
    "grp": "skin",
    "subject": "the person",
    "prompt": "Create an extreme close-up portrait featuring [subject] with very harsh studio lighting. Strong side light exaggerating skin pores, imperfections, and texture. Wet skin appears more reflective with high contrast highlights. Eye remains the focal point with intense sharpness. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_sk_cine",
  ...
  },
  {
    ...
    "grp": "skin",
    "subject": "the person",
    "prompt": "Create a dark extreme close-up portrait featuring [subject] with low-key lighting. Wet skin glistening under minimal light. Hair strands more prominent across the face. Background fades into darkness. Eye still sharply focused with subtle redness, creating a moody and intense atmosphere. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_se_eye",
  ...
  },
  {
    ...
    "grp": "submerged",
    "subject": "the person",
    "prompt": "Create a darker black and white extreme close-up featuring [subject] with deeper shadows and more dramatic contrast. Water appears darker and heavier, with fewer reflections. Eye illuminated more selectively, creating a mysterious and intense mood. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_vb_autumn",
    "nome": "🍂 Outono Vintage",
  ...
  },
  {
    ...
    "grp": "vintage",
    "subject": "the person",
    "prompt": "Create a moody rainy version featuring [subject] sitting beside a vintage white Volkswagen Beetle on a wet street. Reflections on the ground, soft mist in the air. Lighting dim and cinematic with cool tones. Subtle rain droplets visible. Crisp white shirt, black jacket, light blue jeans. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_vb_film",
    ...
    "grp": "vintage",
    "subject": "the person",
    "prompt": "Create a cinematic street photography version featuring [subject] with a film-like look. Slight grain, muted tones, and natural lighting. Background with urban textures and autumn leaves. Same pose next to a vintage white Volkswagen Beetle. Strong documentary vibe. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_he_cine",
    ...
    "grp": "hero",
    "subject": "the person",
    "prompt": "Retrato editorial cinematográfico em 8K apresentando [subject] com estética de super-herói moderno. Fundo vermelho com luz difusa e partículas leves. Iluminação suave porém dramática com highlights no rosto e traje. Pose firme com braços cruzados e expressão determinada. Estilo realista próximo de filme. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "fl_general",
  ...
  },
  {
    ...
    "cat": "flyer",
    "subject": "the person",
    "prompt": "Edit this image into a fitness recruitment poster featuring [subject] in a strong confident pose, arms slightly flexed or hands on hips, energetic expression. Wearing athletic outfit (gym wear). Background dark with red and black tones, smoke effects and light streaks. Headline: 'WE'RE BUILDING CHAMPIONS'. Subtext: 'Join Our Fitness Team'. Hiring: Personal Trainer, Fitness Coach, Nutrition Specialist, Gym Assistant. Bold 'JOIN NOW' button. Contact: fitness@powergym.com. High contrast lighting, dramatic shadows, intense gym vibe. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "fl_restaurant",
    ...
    "cat": "flyer",
    "subject": "the person",
    "prompt": "Edit this image into a restaurant hiring flyer featuring [subject] standing slightly sideways holding a tray or menu, friendly and welcoming smile. Wearing hospitality uniform or elegant outfit. Warm background with golden lighting, restaurant ambiance blur. Headline: 'JOIN OUR TEAM'. Subtext: 'We're Hiring Passionate People'. Positions: Waiter / Waitress, Chef Assistant, Bartender, Kitchen Staff. 'Apply Now' button. Contact: jobs@finebistro.com. Warm lighting, inviting atmosphere, soft glow. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "fl_creative",
  ...
  },
  {
    ...
    "grp": "bw",
    "subject": "the person",
    "prompt": "Cinematic introspective black and white portrait featuring [subject] with stronger contrast between window light and deep shadows. Slightly darker environment, sense of deep reflection. Sharper marked shadows, film-noir style. Subtle cinematic film grain, deeper color grading. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_ls_mirror",
  ...
  },
  {
    ...
    "grp": "lifestyle",
    "subject": "the person",
    "prompt": "A calm [subject] sitting cross-legged on a bed in a cozy minimal bedroom, meditating with eyes closed, wearing an oversized light grey sweatshirt and matching grey joggers. Soft natural morning light from the side window. Around the subject are tiny cute chibi versions of the same identity sitting on shoulders, knees and around, doing activities like reading, meditating, stretching and dancing. Hand-drawn pastel doodles and speech bubbles floating around the head with words like 'Content', 'Focus', 'Growth', 'Sleep', 'Work', 'Recharge'. Cute pastel hearts, stars, smiley faces and sparkles around the scene. Style: soft pastel illustration + realistic photography mix, dreamy wellness vibe, cozy aesthetic, ultra detailed, 4k. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "u_ls_wellness",
  ...
  },
  {
    ...
    "cat": "sensual",
    "subject": "the woman",
    "prompt": "Ultra photorealistic iPhone-style candid photo of [subject], 35mm look, 4:3 ratio, slight handheld motion, mobile HDR. 11:36 PM, warm bedside lamp 3200K, bedroom near unmade bed, intimate quiet night atmosphere. Subject stands near bed, one hand lightly holding hoodie hem slightly lifting it, hip subtly shifted, relaxed stance, calm confident eye contact. Natural beauty, hazel eyes, soft feminine features, curvy realistic silhouette, dark brunette damp loose waves from shower. Outfit: oversized light grey hoodie soft cotton subtly clinging to damp skin, bare legs visible naturally. Realistic skin pores, post-shower glow on shoulders/collarbones/neck, slight moisture sheen, fabric gently following body contours. Mood: intimate, confident, slightly seductive but natural, candid spontaneous. Avoid: explicit nudity, graphic exposure, distortion, artificial skin. preserve identity, keep same face, keep facial structure, keep skin tone, maintain original identity, do not change person, realistic face consistency, preserve original facial expression, keep same emotion, keep same eye expression, keep same pose"
  },
  {
    "id": "sn_bedroom",
...
export const FALLBACK_PADRAO_CATEGORIES = [
  "men",
  "women",
  "unisex",
  "flyer",
...
export const FALLBACK_ARTISTIC_STYLES = [
  {
    "id": "anime",
    "label": "Anime",
    "cat": "anime",
...
export const FALLBACK_ARTISTIC_CATEGORIES = {
  "anime": "Anime & Manga",
...
export const FALLBACK_PRO_PRESETS = [
  {
    "id": "original",
    "nome": "📷 Original",
...
export const FALLBACK_FAST_STYLES = [
  {
    "id": "men_ceo",
    "label": "CEO Portrait",
    "category": "men",
...
export const FALLBACK_VISUAL_STYLES = [
  {
    "id": "livre",
    "emoji": "🆓",
    "desc": "Livre/Personalizado",
    "suffix": ""
  },
  {
    "id": "anime",
    "emoji": "🎌",
    "desc": "Anime",
    "suffix": ", anime style, manga aesthetic"
  },
  {
    "id": "ghibli",
    "emoji": "🌿",
    "desc": "Ghibli",
    "suffix": ", Studio Ghibli style, soft colors, Miyazaki"
  },
  {
    "id": "disney_2d",
    "emoji": "👸",
    "desc": "Disney 2D",
    "suffix": ", Disney 2D animation style"
  },
  {
    "id": "disney_3d",
    "emoji": "🧸",
    "desc": "Disney 3D",
    "suffix": ", Disney Pixar 3D character style"
  },
  {
    "id": "cartoon",
    "emoji": "🎬",
    "desc": "Cartoon",
    "suffix": ", cartoon style, colorful, fun"
  },
  {
    "id": "comic",
    "emoji": "💥",
    "desc": "Comic",
    "suffix": ", comic book style, bold lines"
  },
  {
    "id": "manga",
    "emoji": "📖",
    "desc": "Manga",
    "suffix": ", manga style, black and white ink drawing"
  },
  {
    "id": "cyberpunk",
    "emoji": "🌃",
    "desc": "Cyberpunk",
    "suffix": ", cyberpunk style, neon lights, futuristic"
  },
  {
    "id": "retrowave",
    "emoji": "🌅",
    "desc": "Retrowave",
    "suffix": ", retrowave synthwave, 80s neon aesthetic"
  },
  {
    "id": "fantasy",
    "emoji": "⚔️",
    "desc": "Fantasy",
    "suffix": ", epic fantasy art, magical atmosphere"
  },
  {
    "id": "pixel_art",
    "emoji": "👾",
    "desc": "Pixel Art",
    "suffix": ", pixel art style, retro 16-bit"
  },
  {
    "id": "watercolor",
    "emoji": "🎨",
    "desc": "Watercolor",
    "suffix": ", watercolor painting, soft colors"
  },
  {
    "id": "oil_paint",
    "emoji": "🖼️",
    "desc": "Oil Paint",
    "suffix": ", oil painting, classical art, rich textures"
  },
  {
    "id": "digital_art",
    "emoji": "🖌️",
    "desc": "Digital Art",
    "suffix": ", digital painting, artstation quality"
  },
  {
    "id": "concept_art",
    "emoji": "📝",
    "desc": "Concept Art",
    "suffix": ", concept art, professional game art"
  },
  {
    "id": "sketch",
    "emoji": "✏️",
    "desc": "Sketch",
    "suffix": ", pencil sketch, hand drawn, detailed lines"
  },
  {
    "id": "realistic",
    "emoji": "📷",
    "desc": "Realista",
    "suffix": ", photorealistic, highly detailed, 8k"
  },
  {
    "id": "3d",
    "emoji": "🧊",
    "desc": "3D Render",
    "suffix": ", 3D render, octane render, unreal engine"
  },
  {
    "id": "cute_3d",
    "emoji": "🎀",
    "desc": "Cute 3D",
    "suffix": ", cute 3D chibi, kawaii render"
  },
  {
    "id": "claymation",
    "emoji": "🏺",
    "desc": "Claymation",
    "suffix": ", claymation stop motion style"
  },
  {
    "id": "ukiyoe",
    "emoji": "🏯",
    "desc": "Ukiyo-e",
    "suffix": ", Japanese ukiyo-e woodblock print style"
  },
  {
    "id": "art_nouveau",
    "emoji": "🌺",
    "desc": "Art Nouveau",
    "suffix": ", Art Nouveau style, ornate, flowing lines"
  },
  {
    "id": "tattoo",
    "emoji": "💉",
    "desc": "Tattoo",
    "suffix": ", tattoo design, ink art, bold outlines"
  },
  {
    "id": "vintage",
    "emoji": "📻",
    "desc": "Vintage",
    "suffix": ", vintage retro style, aged colors, nostalgic"
  },
  {
    "id": "splatter",
    "emoji": "💦",
    "desc": "Splatter",
    "suffix": ", paint splatter art, abstract colorful"
  },
  {
    "id": "gothic",
    "emoji": "🦇",
    "desc": "Gothic",
    "suffix": ", gothic dark art, moody atmosphere"
  },
  {
    "id": "steampunk",
    "emoji": "⚙️",
    "desc": "Steampunk",
    "suffix": ", steampunk style, Victorian mechanical"
  },
  {
    "id": "pop_art",
    "emoji": "🎭",
    "desc": "Pop Art",
    "suffix": ", pop art, Andy Warhol, bold colors, halftone"
  },
  {
    "id": "neon_glow",
    "emoji": "💡",
    "desc": "Neon Glow",
    "suffix": ", neon glow effect, glowing edges, dark background"
  },
  {
    "id": "anime_50s",
    "emoji": "👩‍🍳",
    "desc": "Anime 50s",
    "suffix": ", 1950s anime infomercial style, retro anime"
  },
  {
    "id": "furry",
    "emoji": "🐾",
    "desc": "Furry",
    "suffix": ", furry art, anthropomorphic animal character"
  },
  {
    "id": "pokemon",
    "emoji": "⚡",
    "desc": "Pokemon",
    "suffix": ", Pokemon art style, Nintendo game aesthetic"
  },
  {
    "id": "grain",
    "emoji": "🎞️",
    "desc": "Film Grain",
    "suffix": ", film grain, analog photography, cinematic"
  }
];
...
export const FALLBACK_WIZARD_QUESTIONS = {
  "pt": {
...
export const FALLBACK_PERSONALITIES = [
  {
    "id": "criativo",
    "emoji": "🎨",
    "nome": "Criativo",
