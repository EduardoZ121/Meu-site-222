...
export const ARTISTIC_EFFECT_SECTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "polaroid", label: "Polaroid/Vintage", labelEn: "Polaroid/Vintage", prompt: "Polaroid frame and warm instant-film color cast on the scene (same face age)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "grain", label: "Film Grain", labelEn: "Film Grain", prompt: "film grain overlay on the image (not aging the face)" },
