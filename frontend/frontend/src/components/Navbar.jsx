    ...
    <>
      <header
        className={`fixed top-0 inset-x-0 z-50 border-b transition-colors duration-300 ${
          scrolled
            ? "bg-[#0a0a0f]/95 border-rp-border"
            : "bg-[#0a0a0f]/40 border-transparent"
        }`}
      ...
      <AnimatePresence>
        {open && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-40 bg-rp-bg md:hidden flex flex-col items-center justify-center gap-8">
