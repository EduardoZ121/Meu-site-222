...
import { PADRAO_STYLE_EXTENSIONS } from "./padraoStyleExtensions.js";
export const FALLBACK_PADRAO_STYLES = [
  ...
  },
  {
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "Use the reference photo and make an ultra-realistic close-up portrait, [subject] wearing an elegant strapless black suit, seductive and confident expression, striking red lipstick, dramatic fashion lighting with a soft circular spotlight in the background, cinematic aesthetic of beauty editorial photography, ultra HD, Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "wom_coffee",
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "A full-length studio photograph with a professional and elegant aesthetic. It captures [subject] seated in a light wooden chair with a seat and back upholstered in light fabric and straw accents. The subject sits in a confident and relaxed pose, slightly turned toward the camera, with a gentle smile. One hand rests on the arm of the chair, and the legs are crossed at the ankles. Wearing a suit (blazer and pants) in a neutral tone (light beige or gray-green) over a white or cream top. On the feet are light-colored high-heeled shoes with ankle straps. Wearing delicate jewelry: a necklace with a pendant, earrings, and rings. Nails painted a vibrant red. Hair styled medium-length with soft waves, combed to the side. The background is a solid-colored studio backdrop in a uniform, light brown tone. The lighting is studio-style, soft, and directional, coming from a frontal-upward angle. Captured with a prime portrait lens (85mm) on a full-frame camera, f/4.5, ISO 100, 1/200s. Studio lighting with a large softbox as the main light. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "wom_mirror",
  ...
  },
  {
    ...
    "cat": "women",
    "subject": "the woman",
    "prompt": "Create a soft aesthetic selfie featuring [subject] with a gentle confident expression. Lighting warmer and softer, dreamy glow on the skin. Background is a smooth dark wall. Outfit casual modern. Soft natural makeup. Overall mood calm, refined, and gentle while keeping a believable phone-selfie look. Camera: phone selfie, 35mm, f/2.0, ISO 200. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_joker",
    ...
    "grp": "classic",
    "subject": "the person",
    "prompt": "Generate a striking portrait with a central theme of duality and hidden identity. The image should feature [subject] holding a Joker-style clown mask in front of the face. The subject should be depicted in grayscale, suggesting a somber or desaturated reality, with a thoughtful or melancholic expression in the visible eye. The hand, holding the mask, should be detailed and possibly gloved or armored, also in grayscale. The clown mask, however, should be in vibrant color, with its classic red smile, red nose, and blue markings around the eyes, appearing vivid and unsettlingly cheerful. The background should be dark and minimalistic to emphasize the contrast between the subject and the mask. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_rembrandt",
  ...
  },
  {
    ...
    "grp": "classic",
    "subject": "the person",
    "prompt": "Black and white editorial magazine portrait, focus on [subject] seated on a sofa, confident introspective expression, direct gaze to camera, relaxed pose with hand supporting the chin, light dress shirt with a few buttons open, soft side lighting creating contrast and depth, sophisticated interior with curtains and modern decor in the background, realistic skin and fabric texture, high sharpness, professional photographic quality, 85mm f/1.8 lens, cinematic monochrome style. Negative: blurry, cartoonish, oversaturated, smiling, colored image, low contrast. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_lion_winter",
  ...
  },
  {
    ...
    "grp": "lion",
    "subject": "the person",
    "prompt": "Create a powerful cinematic scene showing [subject] and a lion face to face in a warm desert environment, symbolizing dominance and unity. Calm and confident expression, eyes slightly closed, while the lion stands firmly with its mane flowing in the wind. Golden sand dunes stretch across the background with a glowing sunset horizon. Warm orange and gold tones dominate the scene. Strong directional lighting from the side creates dramatic shadows and highlights on the face and lion's fur. Ultra-realistic, cinematic, 8K, golden hour. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_lion_shadow",
  ...
  },
  {
    ...
    "grp": "bw",
    "subject": "the person",
    "prompt": "Create a black and white portrait featuring [subject] with classic Rembrandt lighting but softened for a more elegant and timeless look. Gentle shadow transitions, subtle highlights, and a refined artistic tone. Background remains dark with a soft texture. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_hk_noir",
    "nome": "💻 Hacker Noir",
  ...
  },
  {
    ...
    "grp": "crimson",
    "subject": "the person",
    "prompt": "Create a vertical cinematic portrait featuring [subject] with deep shadows covering part of the face. Low upward angle with dramatic contrast. Background remains deep crimson red but darker toward edges. Lighting sharper with stronger shadow cuts, creating a mysterious and intense presence. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_cr_glow",
  ...
  },
  {
    ...
    "grp": "emotion",
    "subject": "the person",
    "prompt": "Create a black and white portrait featuring [subject] with a vintage analog film aesthetic. Expression tired and vulnerable. Add subtle grain, film texture, and slight imperfections. Lighting medium contrast with natural falloff. Background soft and blurred. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_sk_extreme",
    "nome": "🔬 Pele Extrema",
  ...
  },
  {
    ...
    "grp": "submerged",
    "subject": "the person",
    "prompt": "Create a darker black and white extreme close-up featuring [subject] with deeper shadows and more dramatic contrast. Water appears darker and heavier, with fewer reflections. Eye illuminated more selectively, creating a mysterious and intense mood. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_vb_autumn",
    "nome": "🍂 Outono Vintage",
  ...
  },
  {
    ...
    "grp": "vintage",
    "subject": "the person",
    "prompt": "Create a cinematic street photography version featuring [subject] with a film-like look. Slight grain, muted tones, and natural lighting. Background with urban textures and autumn leaves. Same pose next to a vintage white Volkswagen Beetle. Strong documentary vibe. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_he_cine",
  ...
  },
  {
    ...
    "cat": "flyer",
    "subject": "the person",
    "prompt": "Edit this image into a fitness recruitment poster featuring [subject] in a strong confident pose, arms slightly flexed or hands on hips, energetic expression. Wearing athletic outfit (gym wear). Background dark with red and black tones, smoke effects and light streaks. Headline: 'WE'RE BUILDING CHAMPIONS'. Subtext: 'Join Our Fitness Team'. Hiring: Personal Trainer, Fitness Coach, Nutrition Specialist, Gym Assistant. Bold 'JOIN NOW' button. Contact: fitness@powergym.com. High contrast lighting, dramatic shadows, intense gym vibe. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "fl_restaurant",
    ...
    "cat": "flyer",
    "subject": "the person",
    "prompt": "Edit this image into a restaurant hiring flyer featuring [subject] standing slightly sideways holding a tray or menu, friendly and welcoming smile. Wearing hospitality uniform or elegant outfit. Warm background with golden lighting, restaurant ambiance blur. Headline: 'JOIN OUR TEAM'. Subtext: 'We're Hiring Passionate People'. Positions: Waiter / Waitress, Chef Assistant, Bartender, Kitchen Staff. 'Apply Now' button. Contact: jobs@finebistro.com. Warm lighting, inviting atmosphere, soft glow. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "fl_creative",
  ...
  },
  {
    ...
    "story": "polaroid",
    "subject": "the person",
    "prompt": "Create a playful Polaroid-style photo of [subject] and the other person making fun poses. Slight blur with flash lighting in a dark environment. Background changed to white curtains. The other person holding a red Coca-Cola can while [subject] holds a burger. Both laughing or doing exaggerated expressions, energetic and fun. Polaroid playful style, flash, slight angle snapshot. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "x_a_p1",
  ...
  },
  {
    ...
    "grp": "epic",
    "subject": "the person",
    "prompt": "Same 2×2 grid editorial of [subject] with sunglasses, identical outfit and poses, but teal gradient with subtle texture, slightly harsher lighting, sharper shadows, street-fashion tone. Edgy editorial sharper contrast, 4K, 2×2 grid. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "u_sf_cyber",
  ...
  },
  {
    ...
    "cat": "sensual",
    "subject": "the woman",
    "prompt": "Ultra photorealistic iPhone-style candid photo of [subject], 35mm look, 4:3 ratio, slight handheld motion, mobile HDR. 11:36 PM, warm bedside lamp 3200K, bedroom near unmade bed, intimate quiet night atmosphere. Subject stands near bed, one hand lightly holding hoodie hem slightly lifting it, hip subtly shifted, relaxed stance, calm confident eye contact. Natural beauty, hazel eyes, soft feminine features, curvy realistic silhouette, dark brunette damp loose waves from shower. Outfit: oversized light grey hoodie soft cotton subtly clinging to damp skin, bare legs visible naturally. Realistic skin pores, post-shower glow on shoulders/collarbones/neck, slight moisture sheen, fabric gently following body contours. Mood: intimate, confident, slightly seductive but natural, candid spontaneous. Avoid: explicit nudity, graphic exposure, distortion, artificial skin. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "sn_bedroom",
  ...
  },
  {
    ...
    "cat": "sensual",
    "subject": "the woman",
    "prompt": "Ultra-detailed cinematic portrait of [subject] in a versatile aesthetic. Concept: blend of sport-minimal energy (vibrant athletic outfit, sunglasses, high-angle shot interacting with reflective metallic sphere, strong color contrast background, sharp lighting), urban glamour (rooftop overlooking city, elegant gown with subtle shine, accessories, city lights bokeh), lifestyle mirror (casual athletic outfit indoor mirror), and character-inspired fashion (playful themed outfit clean studio). Combination of natural studio and cinematic lighting, soft controlled shadows. Confident expressive modern, mix of playful elegant cinematic. Editorial fashion 8k sharp textures. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "sn_lux_mirror",
  ...
  },
  {
    ...
    "cat": "sensual",
    "subject": "the woman",
    "prompt": "Fashion/lifestyle portrait of [subject] with voluminous dark curly hair, naturally curvy silhouette, wearing a long light-pink strapless body-fitting dress with soft texture and elegant satin finish (fully covered). Pose: taking a mirror selfie with phone in hand, natural confident posture, slight body lean for composition, relaxed expression. Modern apartment with wooden door and wall mirror, clean contemporary aesthetic. Soft natural light entering, refined editorial atmosphere. Ultra-realistic 8k, sharp focus, natural fabric and skin texture. --ar 4:5. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
  ...
  },
  {
    ...
    "cat": "sensual",
    "subject": "the woman",
    "prompt": "Editorial fashion portrait of [subject], well-defined curvy silhouette, long wavy black hair flowing down the back, wearing fitted white high-neck jumpsuit with satin-finish fabric and elegant side cutouts (fully clothed). Three-quarter pose, one hand firm on waist and the other resting lightly along thigh, hip projected to one side, confident fashion posture, intense direct gaze. Elegant environment: white framed wall, crystal chandelier, vase of red roses, contrast between classical setting and striking presence. Cinematic side soft light with marked highlights, shadows emphasizing silhouette and fabric texture. Natural skin glow, hyperrealistic detail. High-fashion editorial framing, focus on form attitude presence. Sophisticated sensual fashion campaign style. 8k ultra realistic sharp focus cinematic color grading. --ar 4:5. Edit the reference photo in-place like professional retouching: preserve exact identity, same face, facial structure, bone structure, skin tone and ethnicity (do not lighten, darken or alter undertones), maintain original identity, do not change person or race, realistic face consistency for all skin tones including deep and melanin-rich skin, preserve original facial expression, keep same emotion, keep same eye expression, natural symmetric anatomy, no warped or melted features, keep same pose and head angle unless the style explicitly requires otherwise"
  },
  {
    "id": "sn_street_edge",
...
export const FALLBACK_PRO_PRESETS = [
  ...
  },
  {
    ...
    "prompt": "Enhance hair and skin with photorealistic quality. For skin: gentle beauty retouch only — even tone, healthy glow, soft natural finish; do NOT add pores, wrinkles, micro-texture, or any detail that makes the subject look older. No plastic/AI look. Render hair with individually defined strands, natural shine, realistic flow, accurate roots and ends, true-to-life color depth. Preserve identity, facial structure, age, expression, pose, hairstyle shape, outfit, lighting and composition exactly as the reference. The result must look like a high-end retouched professional portrait — refined but believable, never over-smoothed. 8k, ultra-detailed, masterpiece.",
    "category": "enhance"
  },
  {
    "id": "outfit",
