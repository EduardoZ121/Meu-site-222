...
export default function NotificationListPanel({ compact = false, onClose }) {
  const { t } = useI18n();
        ...
        {notifications.length > 0 && (
          <div className="flex items-center gap-0.5 shrink-0">
            ...
            <button
              type="button"
              onClick={clearAll}
              className="p-1.5 rounded-lg text-[#8A8A8E] hover:text-white hover:bg-red-500/10 hover:text-red-200"
