...
export const ARTISTIC_STUDIO_STYLES = [
  // —— Fotografia ——
  { id: "photo_classic_portrait", cat: "photography", label: "Retrato Clássico", labelEn: "Classic Portrait", desc: "Iluminação suave, pele natural, fundo desfocado", descEn: "Soft light, natural skin, blurred background", suffix: "classic portrait photography, soft natural lighting, preserve exact facial age from reference, shallow depth of field, creamy bokeh background, timeless editorial portrait", gradient: ["#1a1a2e", "#4a5568", "#e2e8f0"], icon: "camera" },
  ...
  { id: "photo_glamour", cat: "photography", label: "Glamour", labelEn: "Glamour", desc: "Iluminação de estúdio, pele perfeita, brilho", descEn: "Studio light, flawless skin, shine", suffix: "glamour studio portrait, soft beauty retouch without aging the face, beauty dish lighting, luminous highlights, luxury beauty campaign, same apparent age as reference", gradient: ["#1e1b4b", "#c084fc", "#fdf4ff"], icon: "gem" },
  ...
  // —— Pintura Clássica ——
  { id: "cls_oil", cat: "classic", label: "Óleo", labelEn: "Oil Painting", desc: "Pinceladas visíveis, mestres", descEn: "Visible brushstrokes, old masters", suffix: "classical oil painting on canvas, visible brushstrokes, rich impasto texture, museum fine-art technique, preserve subject age and face from reference", gradient: ["#451a03", "#b45309", "#fde68a"], icon: "brush" },
  ...
  { id: "vin_1920s", cat: "vintage", label: "Anos 1920", labelEn: "1920s Photo", desc: "Sépia, art déco, charleston", descEn: "Sepia, art deco, Charleston", suffix: "1920s vintage photograph color grade and fashion styling only, sepia tones, same subject age as reference, do not make the person look older", gradient: ["#78716c", "#d6d3d1", "#1c1917"], icon: "camera" },
  ...
  { id: "lab_qwen_edit", cat: "nsfw", adminOnly: true, labPreset: true, labBadge: "QWEN", label: "Qwen Edit Rapid", labelEn: "Qwen Edit Rapid", desc: "Edição rápida IA, identidade preservada", descEn: "Rapid AI edit, identity preserved", suffix: "rapid photoreal edit pass, preserve exact face age and body from reference, no added wrinkles or aging", gradient: ["#0c0a1f", "#6366f1", "#22d3ee"], icon: "zap" },
  ...
  { id: "lab_cinematic_edit", cat: "nsfw", adminOnly: true, labPreset: true, textEngine: "flux", editEngine: "kontext", labBadge: "CINE", label: "Cinematic Edit", labelEn: "Cinematic Edit", desc: "Edição moody, luz de filme, drama", descEn: "Moody film lighting, drama", suffix: "cinematic AI image edit, anamorphic mood, dramatic rim lighting, teal orange grade, blockbuster still quality, atmospheric edit, preserve reference age", gradient: ["#0f172a", "#7c3aed", "#f59e0b"], icon: "camera" },
  ...
  { id: "lab_ultra_style", cat: "nsfw", adminOnly: true, labPreset: true, textEngine: "flux", editEngine: "kontext", labBadge: "ULTRA", label: "Ultra Style", labelEn: "Ultra Style", desc: "Máximo detalhe e nitidez premium", descEn: "Maximum detail and premium sharpness", suffix: "ultra high definition AI style transfer, crisp edges, luxury editorial finish, preserve exact facial age from reference", gradient: ["#0a0a0a", "#52525b", "#fafafa"], icon: "gem" },
  ...
  { id: "lab_realistic_edit", cat: "nsfw", adminOnly: true, labPreset: true, textEngine: "flux", editEngine: "kontext", labBadge: "REAL", label: "Realistic Edit", labelEn: "Realistic Edit", desc: "Fotorrealismo extremo pós-edição", descEn: "Extreme photorealism after edit", suffix: "photorealistic AI image edit, natural skin tones, accurate lighting physics, DSLR quality, believable materials, adult editorial portrait, preserve exact age from reference", gradient: ["#1c1917", "#78716c", "#fde68a"], icon: "camera" },
  ...
  { id: "nsfw_swimwear", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Bikini Editorial", labelEn: "Swimwear Editorial", desc: "Praia, bikini, moda swim — segue o teu prompt", descEn: "Beach, bikini, swim fashion — follows your prompt", suffix: "swimwear bikini editorial photography, beach fashion campaign, sun-kissed skin, tasteful adult swimwear styling, follow user wardrobe and pose instructions precisely, preserve exact face age from reference", gradient: ["#0ea5e9", "#f472b6", "#fef08a"], icon: "sun" },
  { id: "nsfw_beach", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Beach Lifestyle", labelEn: "Beach Lifestyle", desc: "Areia, ondas, golden hour na praia", descEn: "Sand, waves, beach golden hour", suffix: "beach lifestyle editorial photography, ocean backdrop, golden hour sand and waves, relaxed vacation mood, natural sunlight, preserve exact face age from reference", gradient: ["#fbbf24", "#38bdf8", "#fef3c7"], icon: "sun" },
  { id: "nsfw_lingerie_soft", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Lingerie Soft", labelEn: "Soft Lingerie", desc: "Renda suave, luz romântica, editorial", descEn: "Soft lace, romantic light, editorial", suffix: "soft lingerie editorial photography, delicate lace fabrics, romantic window light, elegant adult boudoir atmosphere, artistic not explicit, preserve exact face age from reference", gradient: ["#fce7f3", "#f9a8d4", "#831843"], icon: "gem" },
  { id: "nsfw_fitness_glam", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Fitness Glam", labelEn: "Fitness Glam", desc: "Sporty, corpo atlético, activewear", descEn: "Sporty, athletic body, activewear", suffix: "fitness glamour photography, athletic physique unchanged from reference, sporty activewear or bikini, gym or studio lighting, energetic editorial, preserve exact face age", gradient: ["#dc2626", "#1e293b", "#f97316"], icon: "zap" },
  { id: "nsfw_boudoir", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Boudoir", labelEn: "Boudoir", desc: "Retrato íntimo artístico", descEn: "Artistic intimate portrait", suffix: "artistic boudoir photography style, intimate mood, soft romantic lighting, elegant sensual atmosphere, preserve exact face age from reference", gradient: ["#1e1b4b", "#be185d", "#fce7f3"], icon: "gem" },
  { id: "nsfw_pinup", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Pin-up Glam", labelEn: "Pin-up Glam", desc: "Glamour retro sensual", descEn: "Sensual retro glam", suffix: "glamorous pin-up photography style, retro sensual pose, studio beauty lighting, adult editorial glamour, preserve exact face age from reference", gradient: ["#9f1239", "#fbbf24", "#1e3a8a"], icon: "sparkles" },
  { id: "nsfw_dark", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Dark Sensual", labelEn: "Dark Sensual", desc: "Mood sombrio sensual", descEn: "Dark sensual mood", suffix: "dark sensual artistic photography, moody shadows, mysterious atmosphere, cinematic intimate drama, preserve exact face age from reference", gradient: ["#0a0a0a", "#4c0519", "#7c3aed"], icon: "moon" },
  { id: "nsfw_fantasy", cat: "nsfw", adminOnly: true, tier: "light", textEngine: "flux", editEngine: "kontext", label: "Fantasy Pin-up", labelEn: "Fantasy Pin-up", desc: "Fantasia mature ilustrada", descEn: "Mature fantasy illustration", suffix: "fantasy pin-up illustration, heroic fantasy character, stylized sensual fantasy art, digital painting, preserve exact face age from reference", gradient: ["#312e81", "#ec4899", "#fbbf24"], icon: "star" },
  // —— AI Lab pesado (admin) ——
  { id: "nsfw_sheer", cat: "nsfw", adminOnly: true, tier: "heavy", textEngine: "flux", editEngine: "kontext", label: "Sheer Editorial", labelEn: "Sheer Editorial", desc: "Tecidos transparentes, luz dramática", descEn: "Sheer fabrics, dramatic light", suffix: "sheer fabric adult editorial photography, translucent textiles, dramatic studio lighting, high-fashion sensual art direction, preserve exact face age from reference", gradient: ["#1e1b4b", "#a855f7", "#fdf4ff"], icon: "sparkles" },
  { id: "nsfw_figure_study", cat: "nsfw", adminOnly: true, tier: "heavy", textEngine: "flux", editEngine: "kontext", label: "Figure Study", labelEn: "Figure Study", desc: "Nu artístico clássico, estudo de luz", descEn: "Classical artistic nude, light study", suffix: "classical figure study fine art photography, artistic nude form, museum lighting, sculptural body composition, preserve exact face age from reference", gradient: ["#292524", "#78716c", "#fef3c7"], icon: "frame" },
  { id: "nsfw_explicit_art", cat: "nsfw", adminOnly: true, tier: "heavy", textEngine: "flux", editEngine: "kontext", label: "Explicit Art", labelEn: "Explicit Art", desc: "Arte adulta explícita controlada", descEn: "Controlled explicit adult art", suffix: "explicit adult fine art photography, adult artistic nudity, bold sensual composition, gallery explicit art direction, follow user instructions, preserve exact face age from reference", gradient: ["#450a0a", "#be123c", "#0a0a0a"], icon: "gem" },
  { id: "nsfw_intimate_couple", cat: "nsfw", adminOnly: true, tier: "heavy", label: "Intimate Couple", labelEn: "Intimate Couple", desc: "Casal íntimo, mood cinematográfico", descEn: "Intimate couple, cinematic mood", suffix: "intimate couple editorial photography, romantic sensual connection, cinematic bedroom or hotel mood, warm skin tones, preserve exact face age from reference", gradient: ["#4c0519", "#7c2d12", "#fbbf24"], icon: "sparkles" },
  { id: "nsfw_cosplay", cat: "nsfw", adminOnly: true, tier: "light", label: "Cosplay Mature", labelEn: "Mature Cosplay", desc: "Personagem sensual, fantasia", descEn: "Sensual character cosplay", suffix: "adult cosplay photography, detailed costume, playful sensual pose, convention or studio lighting, follow user character and outfit, preserve exact face age from reference", gradient: ["#312e81", "#ec4899", "#22d3ee"], icon: "star" },
  { id: "nsfw_wet_look", cat: "nsfw", adminOnly: true, tier: "light", label: "Wet Look", labelEn: "Wet Look", desc: "Pele molhada, shower ou piscina", descEn: "Wet skin, shower or pool", suffix: "wet look editorial photography, glistening skin, water droplets, shower or pool scene, sensual editorial lighting, preserve exact face age from reference", gradient: ["#0c4a6e", "#38bdf8", "#1e293b"], icon: "droplet" },
  { id: "nsfw_stockings", cat: "nsfw", adminOnly: true, tier: "light", label: "Stockings & Heels", labelEn: "Stockings & Heels", desc: "Meias, ligas, salto alto", descEn: "Stockings, garters, heels", suffix: "stockings and high heels fashion photography, legs focus, luxury boudoir styling, follow user hosiery color, preserve exact face age from reference", gradient: ["#1e1b4b", "#f472b6", "#0a0a0a"], icon: "gem" },
  { id: "nsfw_oil_body", cat: "nsfw", adminOnly: true, tier: "heavy", label: "Oil & Gloss Body", labelEn: "Oil & Gloss Body", desc: "Óleo na pele, brilho corporal", descEn: "Oiled glossy skin", suffix: "add glossy wet oily skin sheen with specular highlights on shoulders arms legs and torso, cinematic studio key and rim light, keep same face and body", gradient: ["#422006", "#fbbf24", "#1c1917"], icon: "sun" },
  {
    ...
    suffix:
      "masterpiece, best quality, semi-realistic 3D character render, full body view, stylized realism hybrid, glossy wet skin sheen on body, oily specular highlights across shoulders arms legs and torso, preserve exact face identity and biological age from reference, no added wrinkles, natural color variation, soft subsurface scattering, physically based rendering, athletic feminine physique, natural muscle definition, cinematic studio lighting, HDR lighting, sharp focus, depth of field, neutral background",
    gradient: ["#422006", "#fbbf24", "#78716c"],
    icon: "gem",
  },
  { id: "nsfw_explicit_pose", cat: "nsfw", adminOnly: true, tier: "heavy", label: "Explicit Pose", labelEn: "Explicit Pose", desc: "Pose adulta explícita — segue prompt", descEn: "Explicit adult pose — follows prompt", suffix: "explicit adult pose photography, follow user pose and framing exactly, preserve exact face age from reference", gradient: ["#450a0a", "#1e1b4b", "#f43f5e"], icon: "camera" },
];
...
export const ARTISTIC_EFFECT_SECTIONS = [
  {
    ...
    options: [
      ...
      { id: "rembrandt", label: "Rembrandt", labelEn: "Rembrandt", prompt: "Rembrandt triangle lighting on scene, soft shadows without adding facial wrinkles or aging the subject" },
      { id: "split", label: "Split Lighting", labelEn: "Split Lighting", prompt: "dramatic split lighting on scene, do not add wrinkles or make the subject look older" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "macro", label: "Macro", labelEn: "Macro", prompt: "macro lens detail on environment and props, not aged skin texture on face" },
      ...
      { id: "polaroid", label: "Polaroid/Vintage", labelEn: "Polaroid/Vintage", prompt: "vintage Polaroid instant film color grade, preserve subject age from reference" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "grain", label: "Film Grain", labelEn: "Film Grain", prompt: "authentic film grain on image grade only, do not age the face" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "sepia", label: "Sepia", labelEn: "Sepia", prompt: "sepia vintage color grade only, same subject age as reference" },
