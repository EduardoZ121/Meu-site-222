/** Tooltips dos efeitos (ícone !) — PT e EN. */
...
export const ARTISTIC_EFFECT_HELP = {
  ...
  en: {
    "lighting:natural": "Sunlight or window light, soft and realistic — great for portraits and lifestyle without a studio look.",
    "lighting:studio": "Controlled softbox lighting — even skin, soft shadows, commercial or beauty look.",
    "lighting:golden": "Golden hour: warm tones, long shadows, romantic end-of-day mood.",
    "lighting:blue": "Blue hour: cool sky, gentle contrast, elegant dusk or night mood.",
    "lighting:backlit": "Light behind the subject — halo, partial silhouette, or strong rim drama.",
    "lighting:rembrandt": "Rembrandt triangle on the face — classic portrait with defined shadow on one side.",
    "lighting:split": "Half the face lit, half in shadow — dramatic editorial contrast.",
    "lighting:butterfly": "Light from above, butterfly shadow under the nose — glamour and beauty.",
    "lighting:rim": "Bright edge outline around the subject — separates from background, cinematic.",
    "lighting:silhouette": "Dark subject on bright background — graphic shape, mystery, strong poster.",

    "lens:35mm": "Wider angle — includes environment, storytelling, documentary feel.",
    "lens:50mm": "Natural perspective close to human vision — versatile for portraits and scenes.",
    "lens:85mm": "Portrait telephoto — blurred background, flattering face, pro look.",
    "lens:135mm": "Long telephoto — compressed planes, very soft background, subject isolation.",
    "lens:macro": "Extreme close-up — eyes, textures, small objects in fine detail.",
    "lens:fisheye": "180° curved distortion — dynamic, urban, or experimental effect.",
    "lens:tilt": "Selective focus miniature effect — scene looks like a scale model.",
    "lens:lensbaby": "Small sharp zone with creative blur around — soft artistic look.",
    "lens:polaroid": "Vintage instant-film look — faded colors, borders, analog nostalgia.",
    "lens:anamorphic": "Cinematic ratio with horizontal flares and oval bokeh — epic film look.",

    "atmosphere:mist_light": "Light mist — atmospheric depth without hiding the subject.",
    "atmosphere:fog_dense": "Dense fog — mysterious mood, silhouette, or ethereal scene.",
    "atmosphere:rain": "Visible rain, wet surfaces, reflections — urban or romantic drama.",
    "atmosphere:snow": "Falling snow — winter setting, cool calm light.",
    "atmosphere:dust": "Particles in lit air — light beams, concerts, deserts.",
    "atmosphere:godrays": "Volumetric god rays — light through smoke or foliage.",
    "atmosphere:bokeh_circle": "Round blur orbs in the background — premium portrait look.",
    "atmosphere:bokeh_hex": "Hexagonal bokeh (lens blades) — artistic optical detail.",
    "atmosphere:vignette_soft": "Soft corner darkening — centers attention without heavy mood.",
    "atmosphere:vignette_strong": "Strong vignette — intimate, vintage, or dark mood.",
    "atmosphere:grain": "Analog film grain — nostalgic organic texture.",
    "atmosphere:leaks": "Colorful light leaks — stylized analog imperfection.",
    "atmosphere:ca": "Chromatic fringing at edges — vintage/digital lens character.",
    "atmosphere:flare": "Lens flares from sun or lamps — cinematic optical effect.",

    "color:warm": "Warm tones (amber, gold) — comfort, sunset, healthy skin.",
    "color:cool": "Cool tones (blue, cyan) — night, tech, calm serenity.",
    "color:desat": "Low saturation — subtle elegance, editorial or melancholy.",
    "color:vibrant": "High saturation — energy, pop, bold campaign look.",
    "color:mono": "One dominant color family — strong graphic coherence.",
    "color:duotone": "Two main colors (e.g. blue shadows + orange light) — modern poster.",
    "color:pastel_mood": "Soft pastels — dream, childhood, light branding.",
    "color:neon_mood": "Saturated neons — cyberpunk, party, futuristic.",
    "color:sepia": "Vintage sepia tone — memory, aged warmth.",
    "color:teal_orange": "Teal & orange cinema grade — blockbuster complementary contrast.",
  },
};
...
export function getArtisticEffectHelp(lang, sectionId, optionId) {
  const key = effectHelpKey(sectionId, optionId);
  const pack = lang === "pt" ? ARTISTIC_EFFECT_HELP.pt : ARTISTIC_EFFECT_HELP.en;
  return pack[key] || ARTISTIC_EFFECT_HELP.en[key] || "";
}
